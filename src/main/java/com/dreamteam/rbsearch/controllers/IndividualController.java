...
//    }
    ...
    public String getSearch(
            ...
            @RequestParam(value = "deposit_rate") String depositRate,
            ...
            @RequestParam(value = "card_annual_service_price") String cardAnnualServicePrice,
            @RequestParam(value = "card_cahsback") String cardCashback,
            ...
            @RequestParam(value = "credit_interest_rate") String creditInterestRate,
            @RequestParam(value = "credit_term") String creditTerm,
            @RequestParam(value = "credit_early_payment", required = false) String creditEarlyPayment,
            @RequestParam(value = "credit_amount") String creditAmount,
            @RequestParam(value = "insurance_aim", required = false) String insuranceAim,
            @RequestParam(value = "insurance_amount") String insuranceAmount,
